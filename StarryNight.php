...
<div class="content container-fluid  font" id="starry">
    <h1>Starry Night</h1>
    ...
    <div class="col-sm-3 col-md-6 col-lg-4">
        <p> Date of Production: <strong>1889</strong><br><br>
            Type of the Painting Colors: <strong>Oil Paint</strong> <br><br>
            Dimensions of Painting: <strong>73.7 cm x 92.1 cm</strong> <br><br>
            Location of painting: <strong>Museum of Modern Art</strong> <br><br>
            Price: <strong>over 100 million</strong> <br><br>
            Genres:  <strong>Post-imperssionism</strong>
        </p>
    </div>
</div>
</body>
