...
//<!-- Claude Monet -->
    ...
    echo "<div class='content container-fluid' id='uffizi'>";
        $sql = "SELECT gname FROM Galleries WHERE id='12'";
        $result = $conn->query($sql);
        if (mysqli_num_rows($result) > 0)
        {
        // output data of each row
        ...
        echo "<div class='col-sm-3 col-md-6 col-lg-4'>";
            echo "<p>";
                $sql = "SELECT gdoe, glocation, gaddress FROM Galleries WHERE id='12'";
                $result = $conn->query($sql);
                if (mysqli_num_rows($result) > 0)
                {
                // output data of each row
                ...
                $sql = "SELECT fname, lname FROM Builder WHERE id='12'";
                $result = $conn->query($sql);
                if (mysqli_num_rows($result) > 0)
                {
                // output data of each row
