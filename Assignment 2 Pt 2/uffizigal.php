...
<div class="content container-fluid"id="uffizi">
  <h1 class="font">Uffizi Gallery</h1>
  <!-- Image -->
  <div class="col-sm-9 col-md-6 col-lg-6">
  ...
  <div class="col-sm-3 col-md-6 col-lg-4">
      <p>    Location: <strong>Italy</strong><br><br>
        Address: <strong>Piazzale degli Uffizi, 6, 50122 Firenze FI</strong> <br><br>
          Date of establishing: <strong> Year 1581</strong> <br><br>
          People involved in building it: <strong>  Giorgio Vasari(started building it) & Alfonso Parigi (continued building it) </strong> <br><br>
          Famous piece of works saved there:
      <ol class = "famousworks">
          <li> <strong>  Santa Trinita Maestà </strong> </li>
          <li> <strong>Primavera </strong> </li>
          <li><strong> The Birth of Venus </strong></li></ol>
      </p>
  </div>
</div><br><br><br>
<!-- Footer section-->
