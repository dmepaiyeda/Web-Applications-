...
<div class="content container-fluid"id="vincent">
  <h1 class="font">Vincent Van Gogh</h1>
  <!-- Image -->
  <div class="col-sm-9 col-md-6 col-lg-6">
  ...
  <div class="col-sm-3 col-md-6 col-lg-4">
      <p> Date of Birth: <strong> March 30, 1853</strong><br><br>
          Date of Death: <strong> July 29, 1890</strong> <br><br>
          Place of their living: <strong>Paris, France</strong> <br><br>
          Painting genres: <strong>Impressionism, Realism, Post-Impressionism </strong> <br><br>
          Famous piece of works: <ol class = "famousworks">
      <li> <strong>Starry Night</strong> </li>
      <li> <strong>	Self-portrait </strong> </li>
      <li><strong> The Potato Eaters</strong></li>
      <li><strong>Irises </strong></li>
      <li><strong>Café Terrace at Night</strong></li>
  </ol>
      </p>
  </div>
</div><br><br><br>
