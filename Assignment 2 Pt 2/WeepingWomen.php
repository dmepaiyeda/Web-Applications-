...
<div class="content container-fluid  font" id="weeping">
    <h1>The Weeping Woman</h1>
    <h3>Pablo Picasso</h3>
    <!-- Image -->
    <div class="col-sm-9 col-md-6 col-lg-6">
        <img id="wwoman" src="https://i.pinimg.com/originals/6c/f6/78/6cf6785c2931400bc048b06a597f23bd.jpg">  <br><br>
    ...
    <div class="col-sm-3 col-md-6 col-lg-4">
        <p> Date of Production: <strong>1937</strong><br><br>
            Type of the Painting colors: <strong>Oil on Canvas</strong> <br><br>
            Dimensions of the Painting: <strong>60 cm x 49 cm</strong> <br><br>
            Location of painting: <strong>Tate Modern, London</strong> <br><br>
            Price: <strong>N/A</strong> <br><br>
            Genres:  <strong>Cubism</strong>
        </p>
    </div>
</div>
</body>
