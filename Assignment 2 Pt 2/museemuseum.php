...
<div class="content container-fluid"id="musee">
  <h1 class="font">Musee Des Beaux-Arts De Bordeaux</h1>
  <!-- Image -->
  <div class="col-sm-9 col-md-6 col-lg-6">
  ...
  <div class="col-sm-3 col-md-6 col-lg-4">
      <p> Location: <strong>France</strong><br><br>
        Address: <strong> 20 Cours d'Albret, 33000 Bordeaux </strong> <br><br>
          Date of establishing: <strong> Year 1801 </strong> <br><br>
          People involved in building it: <strong> Pierre Lacour </strong> <br><br>
          Famous piece of works saved there:
      <ol class = "famousworks">
          <li> <strong> Eliezer and Rebecca </strong> </li>
          <li> <strong>Greece on the ruins of Missolonghi </strong> </li>
          <li><strong> The banks of the Oise </strong></li>
      </ol>
      </p>
  </div>
</div><br><br><br>
