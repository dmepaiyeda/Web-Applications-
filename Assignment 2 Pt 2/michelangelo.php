...
<div class="content container-fluid"id="vincent">
  <h1 class="font">Michelangelo</h1>
  <!-- Image -->
  <div class="col-sm-9 col-md-6 col-lg-6">
      <img id="angelo" src="https://media1.britannica.com/eb-media/46/75046-004-E437D9A2.jpg">  <br><br>
  </div>
  <!-- Information -->
  <div class="col-sm-3 col-md-6 col-lg-4">
      <p> Date of Birth: <strong>March 6, 1475</strong><br><br>
      ...
      <li> <strong>	Sistine Chapel Ceiling </strong> </li>
      <li> <strong>	The Last Judgement </strong> </li>
      <li><strong> Battle of Cascina</strong></li>
      <li><strong>Torment of Saint Anthony </strong></li>
      <li><strong>The Entombment </strong></li>
  </ol>
      </p>
  </div>
</div><br><br><br>
