...
<div class="content container-fluid"id="tate">
  ...
  <div class="col-sm-3 col-md-6 col-lg-4">
      <p>    Location: <strong>United Kingdom</strong><br><br>
        Address: <strong>Bankside; London, SE1</strong> <br><br>

          Date of establishing: <strong> Year 2000 </strong> <br><br>
          People involved in building it: <strong>Sir Giles Gilbert Scott </strong> <br><br>
          Famous piece of works saved there:
      <ol class = "famousworks">
          <li> <strong> I Do, I Undo, I Redo </strong> </li>
          <li> <strong>Double Bind </strong> </li>
          <li><strong>Marsyas</strong></li>
      </ol>
      </p>
  </div>
</div><br><br><br>
