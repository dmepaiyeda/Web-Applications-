...
<div class="content container-fluid"id="ago">
  <h1 class="font">Art Gallery of Ontario</h1>
  <!-- Image -->
  <div class="col-sm-9 col-md-6 col-lg-6">
  ...
  <div class="col-sm-3 col-md-6 col-lg-4">
      <p>  Location: <strong>Canada</strong><br><br>
        Address: <strong> 317 Dundas St W, Toronto, ON M5T 1G4</strong> <br><br>
          Date of establishing: <strong> Year 1900 </strong> <br><br>
          People involved in building it: <strong> Group of private members of the Ontario Society of Artists </strong> <br><br>
          Famous piece of works saved there:
      <ol class = "famousworks">
          <li><strong> The Baroque </strong> </li>
          <li><strong> Adam and Eve </strong> </li>
          <li><strong> The Crucified Christ </strong></li>
      </ol>
      </p>
  </div>
</div><br><br><br>
