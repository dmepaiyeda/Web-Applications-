...
<div class="content container-fluid  font" id="venus">
    <h1>The Birth of Venus</h1>
    <h3>Sandro Botticello</h3>
    <!-- Image -->
    <div class="col-sm-9 col-md-6 col-lg-6">
        <img id="bvenus" src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/0b/Sandro_Botticelli_-_La_nascita_di_Venere_-_Google_Art_Project_-_edited.jpg/450px-Sandro_Botticelli_-_La_nascita_di_Venere_-_Google_Art_Project_-_edited.jpg">  <br><br>
    </div>
    ...
    <div class="col-sm-3 col-md-6 col-lg-4">
        <p> Date of Production: <strong>1486</strong><br><br>
            Type of the Painting colors: <strong>Tempera</strong> <br><br>
            Dimensions of the Painting: <strong>672.5 cm x 278.9 cm</strong> <br><br>
            Location of painting: <strong>Uffizi Gallery</strong> <br><br>
